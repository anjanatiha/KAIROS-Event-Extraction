...
def filter_words(w, exclude_words=[], no_stop_words=False, tag_prefix="", selected_tags=[], stop_words=stop_words_list):
...
def Get_CogComp_SRL_and_NER_results(input_sentence):
    ...
    return tokens, detected_mentions, identified_trigger_positions, trigger_to_arguments, verb_SRL_view
